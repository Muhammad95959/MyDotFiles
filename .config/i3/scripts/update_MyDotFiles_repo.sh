...
cp  ~/.config/dolphinrc  ~/Disk_D/Muhammad/Repositories/DotFiles/.config/
cp  ~/.config/katerc     ~/Disk_D/Muhammad/Repositories/DotFiles/.config/
...
cp  -r  ~/.config/kate         ~/Disk_D/Muhammad/Repositories/DotFiles/.config/
...
cp  -r  ~/.config/uGet         ~/Disk_D/Muhammad/Repositories/DotFiles/.config/
